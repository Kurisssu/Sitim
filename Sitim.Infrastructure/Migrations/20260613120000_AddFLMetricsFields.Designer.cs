...
namespace Sitim.Infrastructure.Migrations
{
    ...
    [Migration("20260613120000_AddFLMetricsFields")]
    partial class AddFLMetricsFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sitim.Core.Entities.FLParticipant", b =>
                {
                    ...
                    b.Property<string>("ClassHistogramJson")
                        .HasColumnType("text")
                        .HasColumnName("class_histogram_json");
            ...
            modelBuilder.Entity("Sitim.Core.Entities.FLRound", b =>
                {
                    ...
                    b.Property<decimal?>("AggregatedMacroF1")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("aggregated_macro_f1");
            ...
            modelBuilder.Entity("Sitim.Core.Entities.Institution", b =>
                {
                    ...
                    b.Property<string>("OrthancPassword")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("OrthancUsername")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("Sitim.Core.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
